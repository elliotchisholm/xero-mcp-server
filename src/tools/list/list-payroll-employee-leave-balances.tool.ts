...
import {
  ...
  listXeroPayrollEmployeeLeaveBalances,
} from "../../handlers/list-xero-payroll-employee-leave-balances.handler.js";
  ...
  async ({ employeeId }) => {
    ...
    return {
      content: [
        ...
        ...(leaveBalances?.map((balance: EmployeeLeaveBalanceResult) => ({
          type: "text" as const,
          text: [
